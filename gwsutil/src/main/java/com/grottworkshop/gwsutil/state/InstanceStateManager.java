 ...
 * See also {@link #saveInstanceState(Object, Bundle)} and
 * {@link #restoreInstanceState(Object, Bundle)} methods.
 *
 * Usage:
 *
...
public class InstanceStateManager<T> {
     ...
     * Supposed to be called from {@link android.app.Activity#onSaveInstanceState(Bundle)} or
     * {@link android.app.Fragment#onSaveInstanceState(Bundle)}.<br/>
     ...
     * Supposed to be called from {@link android.app.Activity#onCreate(Bundle)} or
     * {@link android.app.Fragment#onCreate(Bundle)} prior to using of local fields marked with
