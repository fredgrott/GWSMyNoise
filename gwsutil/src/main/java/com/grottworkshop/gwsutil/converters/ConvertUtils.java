...
public class ConvertUtils {
     ...
     * Shortcut for {@link #toArray(Collection) toArray}({@link #convert(Convertable[]) convert(array)})
     */
    ...
    /**
     * Converting array of convertable items into array of target items<br/>
     * Shortcut for {@link #toArray(Collection, Class) toArray}({@link #convert(Convertable[]) convert(array)}, <code>clazz</code>)
     */
     ...
     * Shortcut for {@link #toArray(Collection) toArray}({@link #convert(Collection) convert(collection)})
     */
    ...
    /**
     * Converting Collection of convertable items into array of target items<br/>
     * Shortcut for {@link #toArray(Collection, Class) toArray}({@link #convert(Collection) convert(array)}, <code>clazz</code>)
     */
    ...
    /**
     * Converting {@link List List} into array<br/>
    ...
    /**
     * Converting {@link List List} into array of given type
     */
    @SuppressWarnings("unchecked")
