 ...
 * Don't forget to initialize it by calling {@link #init(Context, String) init method}
...
public class Preferences {
    ...
    /**
     * Returns {@link SharedPreferences} object with default prefs name provided in {@link #init(Context, String) init method}
     */
